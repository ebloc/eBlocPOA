...
nohup geth --syncmode fast --cache=1024 --shh --datadir $DATADIR/private --port $PORT --rpcaddr 127.0.0.1 --rpc --rpcport 8545 --rpccorsdomain="*" --networkid 23422 --rpcapi admin,eth,net,web3,debug,personal,shh --targetgaslimit '10000000000000' --gasprice "18000000000" --allow-insecure-unlock > $DATADIR/geth_server.out &
